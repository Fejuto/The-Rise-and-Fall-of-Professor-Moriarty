...
class Config {
	public static inline var NodeCastleDecayRate = 2.5;
	...
	public static inline var CastlieLie = -10;
	public static inline var BarracksLie =
	public static inline var MineLie = 
